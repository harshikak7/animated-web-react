  ...
  return (
    <div className='parent'>
      <div id='page1' className='py-1 '>
        <div ref={imageDivRef} className='absolute overflow-hidden lg:h-[20vw] h-[30vw] lg:rounded-3xl rounded-xl lg:w-[15vw] w-[25vw] lg:top-[20vh] -top-80 lg:left-[30vw] left-[30vw]'> 
        ...
        <div className='relative font-[font2]'>
          <div className='lg:mt-[45vh] mt-[30vh]'>
            <h1 className='text-[20vw] text-center uppercase leading-[18vw]'>Creative <br />
              Lifestyle</h1>
          </div>
